            ...
            <View style={styles.verticalContainer}>
                ...
                <View style={{ ...styles.border, marginBottom: 12 }}>
                    <Picker // cinsiyet girişi
                        selectedValue={gender} // ilk baştaki seçilmiş değeri cinsiyet state mizdeki değer yapıyoruz
                        style={styles.picker}
                ...
                <View>
                    <DefaultButton // kayıt ol butonu
                        style={{ width: 262 }}
                        onPress={() => { // kayıt ol butonuna tıklandığında
                            ...
                            if (password !== passwordAgain) {
                                Alert.alert('Hata', 'Şifreler aynı olmalıdır!') // hata veriyoruz
                                return;
                            }

                            auth()
                                .createUserWithEmailAndPassword(email, password) // girilen kullanıcı adı ve şifre ile hesap oluşturuyoruz
                                .then(({ user }) => { // başarıyla kullanıcı hesabı oluşturulduğunda
                                    firestore() // veritabanımızdaki
                                        ...
                                        .set({ // belirliyoruz
                                            ...
                                            type: "customer" // kullanıcının tipi
                                        })
