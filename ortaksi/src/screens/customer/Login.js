...
export default function Login({ navigation }) {
    ...
    return (
        <View
            style={{ height: '100%' }} // bu view in sayfadaki yüksekliğini %100 yapıyoruz
        >
            <View style={styles.container}>
                <View style={styles.verticalContainer}>
                    ...
                    <View>
                        <DefaultButton style={{ width: 262 }} onPress={() => {
                            // giriş butonuna basıldığında bu fonksiyon çağrılıyor
                            ...
                            auth()
                                ...
                                .then(() => {
                                    // başarıyla giriş yaptıktan sonra bu fonksiyon çağrılıyor
                                    console.log("User with email '" + email + "' logged in!"); // giriş yapabildiysek konsola bunu yazdırıyoruz
                                })
                                .catch(error => {
                                    // hatalı giriş olduğunda bu fonksiyon
                ...
                <View style={{
                    ...
                    <DefaultButton style={{ width: 262, height: 33 }} onPress={() => {
                        // kayıt ol butonuna basıldığında bu fonksiyon çağrılıyor
                        navigation.navigate('Customer Register') // kullanıcı kayıt sayfasını açıyoruz
